...
const phoneSettingsSchema = new mongoose.Schema({
    ...
    numberPorting: {
        ...
        originalNumber: {
            type: String,
            default: null // The business's original number before porting
        },
        originalCarrier: {
            type: String,
            default: null // Their previous phone carrier
        },
        portingDate: {
            type: Date,
            default: null
    ...
    alternativeSetup: {
        businessRealNumber: {
            type: String,
            default: null // Their existing number they want to keep
        },
        setupType: {
            type: String,
