...
export const RESPONSE_TEMPLATES = {
    ...
    dental_problem_inquiry: (problem) => `I understand you're asking about ${problem}. Concerns about potential pain or the duration of procedures like oral surgery are very common. While each case is unique, we use modern techniques and anesthesia to ensure patient comfort during procedures. The time required can also vary depending on the specifics.\n\nOur dental team can give you the most accurate information based on your individual situation. Would you like to schedule a consultation? 🦷 I can help arrange that if you provide your full name, phone number, and email address. 😊`,
    acknowledge_symptom: (symptom) => `I'm sorry to hear you're experiencing ${symptom}. It's important to get that checked out by a dentist to understand the cause and the best course of action.\n\nWe can definitely schedule a time for you to come in for an evaluation. To get that set up, could you please provide your full name, phone number, and email address so our scheduling team can contact you to book that appointment? 🦷`,
